...
this["YAD"]["templates"]["dropdown"] = Handlebars.template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "    <div class=\"dropdown__item\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depths[1] != null ? depths[1].avatars : depths[1]),{"name":"if","hash":{},"fn":this.program(2, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "        <div class=\"name\">"
    + alias3(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"name","hash":{},"data":data}) : helper)))
    + "</div>\n        <div class=\"sub\">"
    + alias3(((helper = (helper = helpers.sub || (depth0 != null ? depth0.sub : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"sub","hash":{},"data":data}) : helper)))
    + "</div>\n        <div class=\"clear\"></div>\n    </div>\n";
  ...
  stack1 = ((helper = (helper = helpers.items || (depth0 != null ? depth0.items : depth0)) != null ? helper : alias1),(options={"name":"items","hash":{},"fn":this.noop,"inverse":this.program(4, data, 0, blockParams, depths),"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  if (!helpers.items) { stack1 = alias3.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer + "</div>";
